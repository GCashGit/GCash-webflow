const CASHIN = {
 ...
 'familymart': {
  ...
  'alfamart': {
    ...
    type: 'OTC',
    instructions: [
      'Select GCash Cash-In > Cash-In on the machine.',
      'Enter your 11-digit GCash mobile number and cash-in amount.',
      'Insert cash payment.',
  ...
  'all-day-supermarket': {
    ...
    type: 'OTC',
    instructions: [
      'Inform the cashier that you would like to Cash In to your GCash wallet.',
  ...
  'posible': {
    ...
    instructions: [
      ...
      'Present valid ID and your payment.<br><a href="new.gcash.com/cico/valid-ids">See list of valid IDs ></a>',
  ...
  //   instructions: [
  //       'Inform the cashier that you want to Cash In to your GCash wallet.',
  //       'Provide your mobile number and Cash In amount.',

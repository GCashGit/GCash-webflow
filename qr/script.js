		...
		var e = function () {},
			r = {
				...
				device_parsers: [
					...
					{ regex: '(hiptop|avantgo|plucker|xiino|blazer|elaine|up.browser|up.link|mmp|smartphone|midp|wap|vodafone|o2|pocket|mobile|pda)', device_replacement: 'Generic Smartphone' },
					{
						regex:
